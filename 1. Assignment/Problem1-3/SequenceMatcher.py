...
# Vergleich
#print('Vergleich man. kopiert mit plumper: ', difflib.SequenceMatcher(None, markierterText_txt, plumper_txt).ratio())
#print('Vergleich man. kopiert mit pyPdf  : ', difflib.SequenceMatcher(None, markierterText_txt, pypdf_txt).ratio())

#print('Vergleich man. kopiert mit ACROBAT  : ', difflib.SequenceMatcher(None, markierterText_txt, markierterText_txt_acrobat).ratio())

print('Vergleich man. kopiert mit ACROBAT  : ', difflib.SequenceMatcher(None, plumper_txt, markierterText_txt_acrobat).ratio())

print('Vergleich man. kopiert mit ACROBAT  : ', difflib.SequenceMatcher(None, pypdf_txt, markierterText_txt_acrobat).ratio())